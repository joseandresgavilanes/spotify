            ...
            <form onSubmit={handleSubmit} className={`formulario_contenedor ${entrando ? 'mi-formulario-entrando' : ''}`}>
                ...
                <div className='formulario_nombres'>
                    <label className='formulario_label_nombre'>
                        <div className='formulario_letras_nombre'><h3>Nombre</h3></div>
                    ...
                    <label className='formulario_label_apellido'>
                        <div className='formulario_letras_apellido'><h3>Apellido</h3></div>
                ...
                <label className='formulario_label'>
                    <div className='formulario_letras_correo'><h3>Correo</h3></div>
                    <input className='formulario_inputs_correo'
                        ...
                        onBlur={handleBlur}
                    />
                    {errors.email && <div className='formulario_errores_correo'>{errors.email}</div>}
                </label>
                <br />
                <label className='formulario_label'>
                    <div className='formulario_letras_mensaje'><h3>Mensaje</h3></div>
                    <textarea className='formulario_inputs_textArea'
                        ...
                        onBlur={handleBlur}
                    />
                    {errors.message && <div className='formulario_errores_mensaje'>{errors.message}</div>}
                </label>
                <br />
                <div className='final-formulario'>
                <input className="formulario-submit" type="submit" value="Enviar" />
                {errors.sentI && <div className='formulario_errores_i'>{errors.sentI}</div>}
                {errors.sentC && <div className='formulario_correcto_c'>{errors.sentC}</div>}
                </div>
            </form>
    );
}
