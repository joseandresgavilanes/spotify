...
const Tarjeta = (props) => {
  ...
  return (
    <div
      className={`mi-componente ${entrando ? "mi-componente-entrando" : ""}`}
    >
      <div className="card-vinyl">
        <div className="card_image_container">
          <div className="card-image">
            <img
              className="fotos_about"
              src={imgUrl}
              alt="Foto de los autores"
            />
          </div>
        </div>
        <div className="card-content">
          ...
          <div className="iconos">
            <div className="iconos_redes">
              <a href={props.linkG} target="_blank">
                <i className="fa-brands fa-github"></i>
              </a>
            </div>
            <div className="iconos_redes">
              <a href={props.linkl} target="_blank">
